...
Call log:
  - waiting for getByText('RP').first()
    - locator resolved to <div class="ant-select-item-option-content">RP</div>
  ...
  - retrying click action
    ...
    at C:\Users\CVHS\Documents\VS Code\tests\PracticePlaywright\Vassist.spec.js:56:44
```
