...
```ts
  ...
  21 |   await page.locator("div[class='select-container'] div div[class='ant-select ant-select-outlined custom-select css-dev-only-do-not-override-1wwf28x ant-select-single ant-select-show-arrow'] div[class='ant-select-selector']").click();
